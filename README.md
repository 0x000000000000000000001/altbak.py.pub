...
You may find a compiler [here](https://github.com/purescript-python/purescript-python), but it may be not super active, nowadays. 
...
Compiled output will be committed and exposed here for demonstrative purposes once complete.
